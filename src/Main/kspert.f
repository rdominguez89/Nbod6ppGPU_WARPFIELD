...
*
      REAL*8 TFB(5000),MCFB(5000),MATFB(1:2,5000)
      integer NFILES,TFBI,NPOT
      CHARACTER*200 FILEFB(2000)
      COMMON/extpot/ TFB,MATFB,MCFB,FILEFB,NFILES,TFBI,NPOT
*
      REAL*8 MP2,POTFB
*
...
*       Form one central distance and scalar product of relative motion.
 ...
 65        CONTINUE
           timee2=time
           CALL POTFEEDBACKMOD(TIMEE2,RI2,FMP,MP2,POTFB,1)
           !IF(MP2.NE.MP.AND.MP2.GT.0)
           MP=MP2
           !ZF = 1.0/RI2
           ZF = FMP**(2./3.) !fix forces
